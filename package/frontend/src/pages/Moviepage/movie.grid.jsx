                ...
                <div class="container">
                    <div class="row flex-wrap-reverse justify-content-center">
                                        ...
                                        <div class="row mb-10 justify-content-center">
                                                ...
                                                <div class="movie-grid">
                                                    ...
                                                    <div class="movie-content bg-one">
                                                        ...
                                                        <ul class="movie-rating-percent">
                                                            <li>
                                                                <div class="thumb">
                                                                    <img src="../img/tomato.png" alt="movie" />
                                                                </div>
                                                                <span class="content">88%</span>
                                                            </li>
                                                            <li>
                                                                <div class="thumb">
                                                                    <img src="../img/cake.png" alt="movie" />
                                                                </div>
                                                                <span class="content">88%</span>
                                                            </li>
                                                        </ul>
                                            ...
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="movie-grid">
                                                    <div class="movie-thumb c-thumb">
                                                        <a href="movie-details.html">
                                                            <img src="../img/movie04.jpg" alt="movie" />
                                                        </a>
                                                    </div>
                                                    <div class="movie-content bg-one">
                                                        <h5 class="title m-0">
                                            ...
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="movie-grid">
                                                    <div class="movie-thumb c-thumb">
                                                        <a href="movie-details.html">
                                                            <img src="../img/movie05.jpg" alt="movie" />
                                                        </a>
                                                    </div>
                                                    <div class="movie-content bg-one">
                                                        <h5 class="title m-0">
                                            ...
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="movie-grid">
                                                    <div class="movie-thumb c-thumb">
                                                        <a href="movie-details.html">
                                                            <img src="../img/movie06.jpg" alt="movie" />
                                                        </a>
                                                    </div>
                                                    <div class="movie-content bg-one">
                                                        <h5 class="title m-0">
                                            ...
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="movie-grid">
                                                    <div class="movie-thumb c-thumb">
                                                        <a href="movie-details.html">
                                                            <img src="../img/movie07.jpg" alt="movie" />
                                                        </a>
                                                    </div>
                                                    <div class="movie-content bg-one">
                                                        <h5 class="title m-0">
                                            ...
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="movie-grid">
                                                    <div class="movie-thumb c-thumb">
                                                        <a href="movie-details.html">
                                                            <img src="../img/movie08.jpg" alt="movie" />
                                                        </a>
                                                    </div>
                                                    <div class="movie-content bg-one">
                                                        <h5 class="title m-0">
                                            ...
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="movie-grid">
                                                    <div class="movie-thumb c-thumb">
                                                        <a href="movie-details.html">
                                                            <img src="../img/movie09.jpg" alt="movie" />
                                                        </a>
                                                    </div>
                                                    <div class="movie-content bg-one">
                                                        <h5 class="title m-0">
                                        ...
                                        <div class="movie-area mb-10">
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie01.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                                                    ...
                                                    <div class="book-area">
                                                        <div class="book-ticket">
                                                            <div class="react-item">
                                                                <a href="#0">
                                                                    <div class="thumb">
                                                                        <img src="../img/heart.png" alt="icons" />
                                                                    </div>
                                                                </a>
                                                            </div>
                                                            <div class="react-item mr-auto">
                                                                <a href="#0">
                                                                    <div class="thumb">
                                                                        <img src="../img/book.png" alt="icons" />
                                                                    </div>
                                                            ...
                                                            <div class="react-item">
                                                                <a href="#0" class="popup-video">
                                                                    <div class="thumb">
                                                                        <img src="../img/play-button.png" alt="icons" />
                                                                    </div>
                                            ...
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie02.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                                            ...
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie03.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                                            ...
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie04.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                                            ...
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie05.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                                            ...
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie06.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                                            ...
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie07.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                                            ...
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie08.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                                            ...
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie09.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                                            ...
                                            <div class="movie-list">
                                                <div class="movie-thumb c-thumb">
                                                    ...
                                                    >
                                                        <img class="d-sm-none" src="../img/movie10.jpg" alt="movie" />
                                                    </a>
                                                </div>
                                                <div class="movie-content bg-one">
                                                    <h5 class="title">
                        ...
                        <div class="pagination-area text-center">
                            <a href="#0"
                            ><i class="fas fa-angle-double-left"></i><span>Prev</span></a
                            >
                            <a href="#0">1</a>
                            <a href="#0">2</a>
